---
name: gtm-start
description: Set up the GTM Architecture kit and guide a first ten-account pilot, using the offline demo, company brief, skills and hosted functions.
---

# Start a GTM pilot

Read the root README, [the first-batch guide](../../../docs/first-batch.md), [the company brief](../../../company/brief.example.md) and the selected function contracts. Work from this repository root.

1. Establish one buyer, one problem, one offer and the next useful deliverable from the user's brief. Use existing answers; ask only for facts needed to proceed. Keep unknowns explicit.
